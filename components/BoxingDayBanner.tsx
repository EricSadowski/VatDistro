...
async function BoxingDayBanner() {

    const sale = await getActiveSaleByCouponCode("BOXING24");
  ...
  return (
    <div className='bg-gradient-to-r from-red-600 to-black text-white px-6 py-10 mx-4 mt-2 rounded-lg shadow-lg'>
        ...
        <div className='flex-1'>
            ...
            <div className='flex'>
                <div className='bg-white text-black py-4 px-6 rounded h-full
...
export default BoxingDayBanner